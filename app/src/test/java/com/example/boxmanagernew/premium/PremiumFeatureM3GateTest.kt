...
class PremiumFeatureM3GateTest {
    ...
    fun playFlavor_cutover13_familyBetaNoSuffix() {
        ...
        // play block: FAMILY_BETA true, 1.3.2 / vc 6, nessun suffix package
        ...
        assertTrue(playBlock.contains("versionName = \"1.3.2\""))
        assertTrue(playBlock.contains("versionCode = 6"))
    }
