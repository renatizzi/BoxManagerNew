package com.example.boxmanagernew.importdata.zip
...
/**
 * Pacchetto Esporta/Importa Dati esteso (T5): CSV + photos/objects/.
 * CSV V1 puro resta fuori da questo ZIP.
 */
object ImportDataZip {

    const val CSV_ENTRY = "dati.csv"
