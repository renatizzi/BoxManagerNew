...
| **Build sviluppo** | Topbar **1.3-famigliaB5.14** (etichetta di build, non un altro nome di app). |
...
Poi: Sync Gradle se lo chiede; variante **famigliaDebug** (non `play`); **Run** sul telefono. Topbar attesa: **1.3-famigliaB5.14**.

**Ritest B5.14:** le 4 domande Renato — categorie usate, oggetti in archivio, oggetti in cantina, luoghi in uso. Non B5.13 (Intent/filtro UI ancora KO).
...
Pacchetto: fix ritest promemoria B5.14; CK2 CONVALIDATO; attesa M3 a test Play chiuso
