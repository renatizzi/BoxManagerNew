...
| **Prossimo pacchetto** | **M1b** (layout → `strings.xml` + `values-en`) — M1a chiuso in questa sessione |
| **Branch lavoro** | `cursor/multilingua-m1a-5409` (base `cursor/p1-igiene-file-5409`) |
