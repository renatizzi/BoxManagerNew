...
| **Build sviluppo** | Topbar **1.3-famigliaB5.10** (etichetta di build, non un altro nome di app). |
...
Poi: Sync Gradle se lo chiede; variante **famigliaDebug** (non `play`); **Run** sul telefono. Topbar attesa: **1.3-famigliaB5.10**.

**Ritest B5.10:** inventario Categorie/Oggetti/Posizioni apre le liste anagrafiche (non solo Contenitori); Motore B messaggio+stampa (F7 = lista); contenitori vuoti; swipe Utility→Impostazioni.
...
Pacchetto: fix ritest promemoria B5.10; CK2 CONVALIDATO; attesa M3 a test Play chiuso
