...
| ID | Indicazione |
|----|-------------|
| **B-SEL-CARTELLA** | Disco di rete (Impostazioni + guida semplice) — B5.20 in ritest |
...
| **Build sviluppo** | Topbar **1.3-famigliaB5.20** (etichetta di build, non un altro nome di app). |
...
Poi: Sync Gradle se lo chiede; variante **famigliaDebug** (non `play`); **Run** sul telefono. Topbar attesa: **1.3-famigliaB5.20**.

**Ritest B5.20:** Impostazioni → Disco di rete — messaggi minimalisti CIFS (campi essenziali). Guida: [GUIDA_DISCO_RETE.md](../famiglia/GUIDA_DISCO_RETE.md).
...
|----|------------------|------|
| **B-SEL-CARTELLA** | Disco di rete (card Impostazioni + guida semplice) | **B5.20 in ritest** — [GUIDA_DISCO_RETE.md](../famiglia/GUIDA_DISCO_RETE.md) |
