...
| **Build sviluppo** | **1.3-famigliaB5.11** (versionCode **1330**) — etichetta di build, non nome app |
...
3. Verificare topbar attesa **1.3-famigliaB5.11** in `app/build.gradle.kts` (flavor Gradle `famiglia` = build di sviluppo).
...
**Windows:** `INSTALLA_FAMIGLIA.bat` — topbar attesa **1.3-famigliaB5.11**.
