...
| ID | Indicazione |
|----|-------------|
| **B-ROTATE-FORM-DRAFT** | Rotazione in inserimento: testo sparisce prima di conferma (10/09) — Aperto; vedi Promemoria |
| **B-PIANO-RILASCIO-RP** | **CONVALIDATO** Nota 9.2 (4.21+4.23) — [REQUISITI](../famiglia/REQUISITI_PIANO_RILASCIO_ROADMAP.md) |
...
| **Build sviluppo** | **1.3-famigliaB5.22** (versionCode **1341**) — etichetta di build, non nome app |
