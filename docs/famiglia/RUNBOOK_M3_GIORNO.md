...
| 4a | Renato PC | **Prima di Play (regola 13/09):** `git pull` → Build Variant **`playDebug`** → **Run** sul telefono → topbar **`v. 1.3`** (senza famiglia). Stesso processo di sempre; AAB dopo con **playRelease** |
