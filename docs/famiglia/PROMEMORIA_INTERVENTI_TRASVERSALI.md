...
| **B-PRE-PLAY-PHONE-TEST** | 13/09/2026 | Prima di ogni upload Play: Renato testa sul telefono con lo stesso flusso Run/install di sempre, ma variante **`playRelease`** (non `famiglia*`); topbar ufficiale senza «famiglia»; solo dopo AAB + upload; release fino a Invio (non bozza). | **SI Renato 13/09** — regola permanente in SOLO_TU, runbook, checklist, `docs/play/README.md` |
