...
| **B-PRE-PLAY-PHONE-TEST** | 13/09/2026 | Prima di ogni upload Play: Renato testa sul telefono con lo stesso flusso Run/install di sempre, Run con **`playDebug`** (non `famiglia*`; `playRelease` solo per AAB firmato); topbar ufficiale senza «famiglia»; solo dopo AAB + upload; release fino a Invio (non bozza). | **SI Renato 13/09** (+ precisazione firma 13/09) — SOLO_TU, runbook, checklist, `docs/play/README.md` |
