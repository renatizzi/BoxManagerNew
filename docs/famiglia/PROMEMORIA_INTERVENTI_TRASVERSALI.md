...
| **B-NO-FAMILY-UI** | 10/09/2026 | Nell’app ufficiale Play: sparisce «family/famiglia» (topbar `1.3`, niente `.famiglia`, testi utente → archivio condiviso / household). | **SI Renato 10/09** — obbligatorio in aggregato codice M3 (B); runbook aggiornato |
