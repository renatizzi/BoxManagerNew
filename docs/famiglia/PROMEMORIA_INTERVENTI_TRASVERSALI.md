...
| **A3 Foto oggetto** | [REQUISITI_FOTO_OGGETTO.md](REQUISITI_FOTO_OGGETTO.md) (**congelato** + CONVALIDA documento 07/09; **R6 + T6bis Premium**) · [ASSESSMENT_FOTO_MINIATURA.md](ASSESSMENT_FOTO_MINIATURA.md) (storico) · OCR: [ASSESSMENT_OCR_COVER.md](ASSESSMENT_OCR_COVER.md) · ingresso: [PROMPT_CONTINUITA_A3_FOTO.md](PROMPT_CONTINUITA_A3_FOTO.md) | **CODICE SU PR #35** (foto+OCR+T4+T5) — play target **1.3.8**; **manca merge `main` + test device** |
