...
| **B-IDEA-OCR-COVER** | 10/09/2026 | Idea: OCR locale su scatto HD temporaneo in fase censimento, poi solo mini foto (barcode scartato). Annotata in [REQUISITI_FOTO_OGGETTO.md](REQUISITI_FOTO_OGGETTO.md) §6. | **FEEDBACK** 17/09 (Q1–Q7) — [ASSESSMENT_OCR_COVER.md](ASSESSMENT_OCR_COVER.md); attesa **CONVALIDA**; zero codice OCR |
