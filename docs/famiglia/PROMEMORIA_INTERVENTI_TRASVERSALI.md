...
- Non duplicare qui il dettaglio prodotto delle fette B0–B5 → Nota ufficiale **Allegato 4.20**; copia di lavoro [NOTA_B0_MERGE_FAMIGLIA.md](NOTA_B0_MERGE_FAMIGLIA.md).
