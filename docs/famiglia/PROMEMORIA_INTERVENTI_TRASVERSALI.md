...
|------|-----------|--------|
| **A1 QR avanzato** | [REQUISITI_QR_AVANZATO.md](REQUISITI_QR_AVANZATO.md) (**congelato** + CONVALIDA documento 07/09; R10 premium) · [ASSESSMENT_QR_AVANZATO.md](ASSESSMENT_QR_AVANZATO.md) | **IN CORSO** 14/09 — ripresa WIP `f523735` (SI Renato: apri senza altra conferma). Batch PDF L0/L1 + share; gate QR_LABEL |
