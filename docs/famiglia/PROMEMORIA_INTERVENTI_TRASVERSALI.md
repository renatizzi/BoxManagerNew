...
| **B-IDEA-OCR-COVER** | 10/09/2026 | Idea: OCR locale su scatto HD temporaneo in fase censimento, poi solo mini foto (barcode scartato). Annotata in [REQUISITI_FOTO_OGGETTO.md](REQUISITI_FOTO_OGGETTO.md) §6. | **ANALISI** 17/09 con SI A3 — [ASSESSMENT_OCR_COVER.md](ASSESSMENT_OCR_COVER.md); **zero codice OCR** finché CONVALIDA |
