...
**Fetta B5:** **CONVALIDATO** (SI Renato, 31/08/2026). **Correttivo T2:** build **1.3-famigliaB5.3**. **B5.4:** Archivio condiviso in Guida e tra le funzioni avanzate (Archivio completo).
